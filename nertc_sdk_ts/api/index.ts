    ...
    */
    ...
    initEventHandler(): void {
       ...
       /** 
         ...
         */
        this.nertcEngine.onAudioFrameObserver('onAudioFrameDidRecord', true, function (
            data: ArrayBuffer,
            length: number
        ) {
         ...
         * @param {number} length数据长度。
         */
        this.nertcEngine.onAudioFrameObserver('onAudioFrameWillPlayback', true, function (
            data: ArrayBuffer,
            length: number
        ) {
         ...
         * @param {number} length数据长度。
         */
        this.nertcEngine.onAudioFrameObserver('onMixedAudioFrame', true, function (
            data: ArrayBuffer,
            length: number
        ) {
         ...
         * @param {number} length数据长度。
         */
        this.nertcEngine.onAudioFrameObserver('onPlaybackAudioFrameBeforeMixing', true, function (
            userID: number,
            data: ArrayBuffer,
            length: number
