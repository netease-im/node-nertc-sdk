...
class NERtcEngine extends events_1.EventEmitter {
     ...
     * </pre>
     */
    setRemoteHighPriorityAudioStream(enable, uid, streamType) {
     ...
     * </pre>
     */
    subscribeRemoteAudioSubStream(uid, subscribe) {
     ...
     * </pre>
     */
    enableLocalAudioStream(enable, streamType) {
     ...
     * </pre>
     */
    enableLoopbackRecording(enable, deviceName = 'NeCastAudio') {
     ...
     * </pre>
     */
    adjustUserPlaybackSignalVolume(uid, volume, streamType) {
    ...
    enableBeauty(enabled) {
        return this.nertcEngine.enableBeauty(enabled);
    }
    /**
     * 启用美颜时，启用或关闭镜像模式
     * @since 4.1.114
     ...
     */
    enableBeautyMirrorMode(enabled) {
        return this.nertcEngine.enableBeautyMirrorMode(enabled);
    }
    /**
     * 获取指定美颜类型的强度设置。
     * @since 4.1.114
     ...
     * </pre>
     */
    addBeautySticker(filePath) {
        return this.nertcEngine.addBeautySticker(filePath);
    }
    /**
     * 取消贴纸效果。
     * @since 4.1.114
     ...
     * </pre>
     */
    addBeautyMakeup(filePath) {
        return this.nertcEngine.addBeautyMakeup(filePath);
    }
    /**
     * 取消美妆效果。
     * @since 4.1.114
