...
class NERtcEngine extends events_1.EventEmitter {
    ...
    * </pre>
    */
    setLocalRenderMode(scalingMode) {
    ...
    * </pre>
    */
    setLocalSubStreamRenderMode(scalingMode) {
    ...
    * </pre>
    */
    setRemoteRenderMode(uid, scalingMode) {
    ...
    */
    ...
    initEventHandler() {
        ...
        /**
          ...
          * 有本地音频数据驱动就会回调。
          * </pre>
          * @event NERtcEngine#onAudioFrameDidRecord
          * @param {ArrayBuffer} data 数据。
          * @param {number} length数据长度。
          */
        this.nertcEngine.onAudioFrameObserver('onAudioFrameDidRecord', true, function (data, length) {
            fire('onAudioFrameDidRecord', data, length);
        });
        /**
         * 播放音频数据回调，用于声音处理等操作。
         * <pre>
         ...
         * 有本地音频数据驱动就会回调。
         * </pre>
         * @event NERtcEngine#onAudioFrameWillPlayback
         * @param {ArrayBuffer} data 数据。
         * @param {number} length数据长度。
         */
        this.nertcEngine.onAudioFrameObserver('onAudioFrameWillPlayback', true, function (data, length) {
            fire('onAudioFrameWillPlayback', data, length);
        });
        /**
         ...
         * @param {number} length数据长度。
         */
        this.nertcEngine.onAudioFrameObserver('onMixedAudioFrame', true, function (data, length) {
            fire('onMixedAudioFrame', data, length);
        });
        /**
        * 获取单个远端用户混音前的音频数据。
        * <pre>
        ...
        * 有本地音频数据驱动就会回调。
        * </pre>
        * @event NERtcEngine#onPlaybackAudioFrameBeforeMixing
        * @param {number} userID 用户ID。
        * @param {ArrayBuffer} data 数据。
        * @param {number} length数据长度。
        */
        this.nertcEngine.onAudioFrameObserver('onPlaybackAudioFrameBeforeMixing', true, function (userID, data, length) {
            fire('onPlaybackAudioFrameBeforeMixing', userID, data, length);
        });
        //  /**
        //          * 安装声卡回调
