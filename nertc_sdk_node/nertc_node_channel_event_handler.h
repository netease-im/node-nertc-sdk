...
public:
    ...
    //virtual void onUserVideoMute(nertc::NERtcVideoStreamType videoStreamType, uid_t uid, bool mute);
...
private:
    ...
    //void Node_onUserVideoMute(nertc::NERtcVideoStreamType videoStreamType, uid_t uid, bool mute) 
