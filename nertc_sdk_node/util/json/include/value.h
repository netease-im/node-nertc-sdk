...
#ifndef NEMEETING_UTIL_CPPTL_JSON_H_INCLUDED
#define NEMEETING_UTIL_CPPTL_JSON_H_INCLUDED
...
template <>
inline void swap(nemeeting_util::Json::Value& a, nemeeting_util::Json::Value& b) {
    a.swap(b);
}
}  // namespace std
...
#endif  // NEMEETING_UTIL_CPPTL_JSON_H_INCLUDED
